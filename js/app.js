    ...
    navigation: [
        [
            'blognav0',
             ...
             <a href="#" class="navigationLogo"><h1>FireBlogs</h1>
             </a>
  ...
  .navbar-nav a:hover{
    ...
    `,
      ...
      'js goes here',
          ...
          <a href="#" class="logoBtn">  <img class="logo" src="img/Amazon_logo.svg.webp" alt=""></a>
          ...
          <a href="#" class="account"><h1 class="accountText">Hello,Sign In</h1></a> 
...
setTimeout(() => {
  dispMessage('you can chose blog, ecommerce or portfolio');
...
function lobby(quiz) {
    if (quest == 'What type of website you want to make' ) {
      createNavFot();
        ...
        setTimeout(() => {
          dispMessage('you can add banner, navigation, card,  section or footer');
